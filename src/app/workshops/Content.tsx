  ...
  fa: {
    ...
    events: [
      ...
      },
      {
        ...
        desc: 'از ایده تا ساخت یک محصول دیجیتال واقعی. در این کارگاه یاد می‌گیرید چگونه با کمک ابزارهای هوش مصنوعی یک وب‌سایت حرفه‌ای طراحی کنید و فرآیندهای کاری را با اتوماسیون‌های هوشمند ساده‌تر و سریع‌تر کنید. شرکت‌کنندگان با مفاهیم طراحی وب، ساخت صفحات مدرن، ابزارهای AI در توسعه وب و ایجاد گردش‌کارهای خودکار با ابزارهایی مانند n8n آشنا می‌شوند.',
