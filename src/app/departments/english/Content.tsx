...
const GENERAL_FA: GenSection[] = [
  ...
  },
  {
    ...
    title: 'ساختار جلسات',
    items: [
      'کلاس‌های زبان مؤسسه هامون هفته‌ای ۱ جلسه است.',
...
const DEPT = {
  fa: {
    ...
    policyBody: 'در مؤسسه هامون، یادگیری یک مسیر پیوسته و زنجیره‌وار است. هیچ زبان‌آموزی نمی‌تواند بدون گذراندن دوره‌های قبلی، مستقیماً وارد سطوح بالاتر (مانند سطح ۲ و بعد از آن) شود. تمامی زبان‌آموزان جدید واجد شرایط، الزامات آموزشی را از «سطح ۱» آغاز خواهند کرد.',
    detailBtn: 'مشاهده جزئیات',
    sessionsLabel: 'طول دوره',
    goalLabel: 'هدف آموزشی',
    generalTitle: 'اطلاعات عمومی مؤسسه هامون',
    general: GENERAL_FA,
    features: [
