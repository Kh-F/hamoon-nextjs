    ...
    features: [
      {
        ...
        title: 'تفکر منطقی و استدلال ریاضی',
        desc: 'دانش‌آموز یاد می‌گیرد چگونه فکر کند، دلیل بیاورد و مسائل را مرحله‌به‌مرحله تحلیل کند؛ مهارتی که پایه موفقیت در ریاضی، علوم و برنامه‌نویسی است.',
      },
      {
        ic: 'target', soft: 'var(--blue-50)', ink: 'var(--blue-600)',
        title: 'حل مسئله و خلاقیت ریاضی',
        desc: 'به جای حفظ کردن فرمول‌ها، دانش‌آموز روش‌های مختلف حل مسئله را کشف می‌کند و یاد می‌گیرد برای چالش‌های جدید راه‌حل پیدا کند.',
      },
      {
        ic: 'calculator', soft: 'var(--mint-50)', ink: 'var(--mint-600)',
        title: 'الگوها، ترکیبیات و ساختارهای گسسته',
        desc: 'آشنایی با الگوها، منطق، گراف‌ها و ایده‌های جذاب ریاضی که پایه علوم کامپیوتر، هوش مصنوعی و فناوری‌های آینده هستند.',
      },
    ],
  },
  en: {
