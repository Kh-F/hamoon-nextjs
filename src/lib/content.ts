...
export const CONTENT: Record<Lang, PageContent> = {
  fa: {
    ...
    about: {
      ...
      note: 'مؤسسه‌ی هامون متعلق به فرزندان ایران زمین است. اگر در پرداخت هزینه مشکل دارید، با ما تماس بگیرید. شما می‌توانید از کتاب‌های ما استفاده کنید و در جلسات رفع اشکال ماهانه شرکت کنید.',
    },
    pillars: [
