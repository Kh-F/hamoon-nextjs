...
export const CONTENT: Record<Lang, PageContent> = {
  fa: {
    ...
    courses: [
      { ic: 'chat', title: 'مکالمه انگلیسی نوجوانان', desc: 'کلاس‌های تعاملی با بازخورد اختصاصی برای هر زبان‌آموز.', soft: 'var(--blue-50)', ink: 'var(--blue-600)', badge: 'پرطرفدار', meta: ['۱۲ جلسه', '۱۳–۱۷ سال'] },
      { ic: 'calculator', title: 'ریاضی هوشمند کودکان', desc: 'یادگیری مفهومی ریاضی با بازی و چالش‌های گروهی.', soft: 'var(--amber-50)', ink: 'var(--amber-600)', badge: 'جدید', meta: ['۸ جلسه', '۷–۱۰ سال'] },
      { ic: 'flask', title: 'سواد علمی و کاوش', desc: 'آزمایش، پرسش و کشف؛ پرورش ذهن کنجکاو دانش‌آموز.', soft: 'var(--mint-50)', ink: 'var(--mint-600)', badge: 'STEM', meta: ['۱۰ جلسه', '۹–۱۲ سال'] },
    ...
    contact: [
      ...
      { ic: 'mail', label: 'ایمیل', value: 'hello@hamoon.academy' },
      { ic: 'clock', label: 'ساعات پاسخگویی', value: 'شنبه تا پنجشنبه · ۹ تا ۱۹' },
      { ic: 'globe', label: 'وب‌سایت', value: 'www.hamoon.academy' },
    ],
    ...
    ages: ['کودک (۶–۹ سال)', 'نوجوان (۱۰–۱۳ سال)', 'نوجوان (۱۴–۱۷ سال)', 'بزرگسال'],
  ...
  en: {
    ...
    courses: [
      { ic: 'chat', title: 'Teen English Conversation', desc: 'Interactive classes with dedicated feedback for every learner.', soft: 'var(--blue-50)', ink: 'var(--blue-600)', badge: 'Popular', meta: ['12 sessions', 'Ages 13–17'] },
      { ic: 'calculator', title: 'Smart Math for Kids', desc: 'Conceptual math learning through play and group challenges.', soft: 'var(--amber-50)', ink: 'var(--amber-600)', badge: 'New', meta: ['8 sessions', 'Ages 7–10'] },
      { ic: 'flask', title: 'Science Literacy & Inquiry', desc: 'Experiment, question and discover; nurturing a curious mind.', soft: 'var(--mint-50)', ink: 'var(--mint-600)', badge: 'STEM', meta: ['10 sessions', 'Ages 9–12'] },
    ...
    contact: [
      ...
      { ic: 'mail', label: 'Email', value: 'hello@hamoon.academy' },
      { ic: 'clock', label: 'Support hours', value: 'Sat–Thu · 9:00 to 19:00' },
      { ic: 'globe', label: 'Website', value: 'www.hamoon.academy' },
    ],
    ...
    ages: ['Child (6–9)', 'Pre-teen (10–13)', 'Teen (14–17)', 'Adult'],
