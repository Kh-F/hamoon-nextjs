...
export const CONTENT: Record<Lang, PageContent> = {
  fa: {
    ...
    founders: [
      {
        name: 'سعید موسی‌وند دارانی',
        role: '',
        bio: 'سعید موسی‌وند دارانی با سال‌ها تجربه در مدیریت آموزش و توسعه محصولات یادگیری، بینش راهبردی و مسیر رشد آکادمی هامون را شکل داده است. تخصص او در طراحی سیستم‌های آموزشی مؤثر و ایجاد محیط‌های یادگیری پویا، سنگ بنای موفقیت هامون است.',
        linkedin: '#', cv: '#',
